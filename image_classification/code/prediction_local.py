...
image_path = os.path.join(f'C:\\Users\\DavidS10\\PycharmProjects\\pythonProject\\image_classification\\', 'position3-frame_88.tif')
image = tifffile.imread(image_path)
image_label_path = os.path.join(f'C:\\Users\\DavidS10\\PycharmProjects\\pythonProject\\image_classification\\', 'position3_seg-frame_88.tif')
...
weight_path = os.path.join('C:\\Users\\DavidS10\\PycharmProjects\\pythonProject\\image_classification\\',
                           'model_image_segmentation_run_after_load_weights_previous_retrained_7_BS128.h5')
