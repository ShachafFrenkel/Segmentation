...
if __name__ == '__main__':
    ...
    # image_2 = os.path.join(args.data_path, 'position3-frame_172.tif')
    image_labels_1 = os.path.join(args.data_path, 'position3_seg_rotate-frame_41.tif')
    # image_labels_2 = os.path.join(args.data_path, 'position3_seg_rotate-frame_172.tif')
    ...
    def image_generator_train( bs, mode="train", aug=None):
        while True:
            ...
            while len(images_label) < bs:
                ...
                m = np.max(image[:,rand_int_1:rand_int_1+64,rand_int_2:rand_int_2+64])
                single_image = np.divide(image[:,rand_int_1:rand_int_1+64,rand_int_2:rand_int_2+64],m)
                single_image_label = image_l[1,rand_int_1:rand_int_1 + 64, rand_int_2:rand_int_2 + 64]
                ...
                # was first 1
                single_image_rotate = np.transpose(single_image_rotate).reshape((64, 64,2))
                # single_image = single_image.reshape((128, 128,2))
                single_image_label_rotate = np.transpose(single_image_label_rotate.reshape((64,64)))
                single_image_label_2channels = np.zeros((2, 64, 64))
